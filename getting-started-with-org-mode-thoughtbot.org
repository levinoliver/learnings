...
** TODO something i need todo press to invode the dealine =C-c d=  use the shift left right to move the calender dates.
DEADLINE: <2024-08-14 Wed>
** DONE something that i have done now 
** something i have done and 
** archiving by ~C-c C-x C-a~ append in a particular org file.
